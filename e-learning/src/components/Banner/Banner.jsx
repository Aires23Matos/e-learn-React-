                ...
                <div className="flex flex-col justify-center">
                    ...
                    space-y-12">
                        ...
                        className="text-3xl md:text-4xl font-bold !leading-snug">
                            A plataforma líder mundial em aprendizagem on-line
                        </motion.h1>
                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            rounded-2xl hover:bg-white duration-300 hover:shadow-2xl">
                                ...
                                <p className="text-lg"> 10,000+ Cursos</p>
                            </motion.div>
                            <motion.div 
                            variants={FadeUp(0.4)}
                            initial= "initial"
                            ...
                            rounded-2xl hover:bg-white duration-300 hover:shadow-2xl">
                                ...
                                <p className="text-lg">Instrução Especializada</p>
                            </motion.div>
                            <motion.div 
                            variants={FadeUp(0.6)}
                            initial= "initial"
                            ...
                            rounded-2xl hover:bg-white duration-300 hover:shadow-2xl">
                                ...
                                <p className="text-lg">Acesso vitalício</p>
                            </motion.div>
                        </div>
                    </div>
                </div>
