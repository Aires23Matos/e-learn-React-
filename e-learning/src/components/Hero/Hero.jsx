    ...
    return(
        ...
        overflow-hidden relative">
            ...
            min-h-[650px]">
              ...
              !leading-snug">Vamos aprender a construir um{" "} <span className="
                text-secondary">websute</span> para o seu negócio
                </motion.h1>
               <motion.div 
               variants= {FadeUp(0.8)}
               initial= 'initial'
               animate= "animate"
               className="fle justify-center md:justify-start">
              ...
              <div className="flex justify-center items-center">
                ...
                src={HeroPng} alt="" className="w-[400px] 
